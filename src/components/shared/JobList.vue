      ...
      <div class="listings-container">
        <a href="/ilan-detay/slug" class="listing full-time">
          ...
          <div class="listing-title">
            ...
            <ul class="listing-icons">
              <li>
                <i class="ln ln-icon-Management"></i> King</li>
              <li>
                <i class="ln ln-icon-Map2"></i> Sydney</li>
              <li>
                <i class="ln ln-icon-Money-2"></i> $5000 - $7000</li>
              <li>
        ...
        <a href="/ilan-detay/slug" class="listing part-time">
          ...
          <div class="listing-title">
            ...
            <ul class="listing-icons">
              <li>
                <i class="ln ln-icon-Management"></i> Cubico</li>
              <li>
                <i class="ln ln-icon-Map2"></i> Sydney</li>
              <li>
                <i class="ln ln-icon-Money-2"></i> $125 / hour</li>
              <li>
        ...
        <a href="/ilan-detay/slug" class="listing internship">
          ...
          <div class="listing-title">
            ...
            <ul class="listing-icons">
              <li>
                <i class="ln ln-icon-Management"></i> Hexagon</li>
              <li>
                <i class="ln ln-icon-Map2"></i> London</li>
              <li>
                <i class="ln ln-icon-Money-2"></i> $55 / hour</li>
              <li>
          ...
          <div class="listing-title">
            ...
            <ul class="listing-icons">
              ...
              <li>
                <i class="ln ln-icon-Map2"></i> London</li>
              <li>
                <i class="ln ln-icon-Money-2"></i> $85 / hour</li>
              <li>
                <div class="listing-date">4d ago</div>
              </li>
            </ul>
